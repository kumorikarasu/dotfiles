...
au BufRead,BufNewFile *.tf,*.tf.j2 set syntax=tf
au BufRead,BufNewFile *.tfvars,*.tfvars.j2 set syn=sh
...
au BufRead,BufNewFile *.yaml,*.yaml.j2,*.yml,*.yml.j2 set syn=yaml
